...
class TreeImportEvent(GenericImportEvent):
    ...
    def ordered_legal_fields_capitalized(self):
        udf_names = self._get_udf_names()
        return fields.trees.capitalize(fields.trees.ALL) + udf_names
    ...
    def legal_and_required_fields_capitalized(self):
        legal_fields = set(self.ordered_legal_fields_capitalized())
        return legal_fields, fields.trees.capitalize(self._required_fields())
