...
from planting.models import PlantingPlan
from planting.views import (add_plan, get_plan,
                            update_plan, delete_plan, get_plans_context)
from planting.run_model.GrowthAndMortalityModel import GrowthAndMortalityModel
from planting.run_model.GrowthModelUrbanTreeDatabase import bisect
from planting.run_model.MortalityModelUrbanTreeDatabase import DIAMETER_BREAKS
...
class TestPlanCrud(OTMTestCase):
    ...
    def test_delete_plan(self):
        ...
        self.assertFalse(PlantingPlan.objects.all().exists())
...
class TestPlansList(OTMTestCase):
    ...
    def _make_plan(self, name, owner, is_published, **kwargs):
        return PlantingPlan.objects.create(instance=self.instance,
                                           owner=owner,
                                           name=name,
